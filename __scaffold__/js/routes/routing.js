...
export default function routes(store) {
    ...
    childRoutes: [
      ...
      {
        path: "/",
        components: {main: null, cart: null},
        // 示範較單純的 async data-fetching 手法
        onEnter: null/*fetchCommon( actions.readAll, (reduxState) => { return reduxState.products.$fetched==true} )*/,
      },
      {
        path: "/:id",
        components: {main: null, cart: null},
        onEnter: null/*ProductDetail.onEnter(store)*/,  // 示範使用 @decorator 做 aysnc data-fetching
